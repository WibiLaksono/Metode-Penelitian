...
# ---------- CONFIG ----------
CONFIG = {
    "mailto": "wibilaksonowijaya@mail.ugm.ac.id",   # gunakan emailmu untuk Crossref/Unpaywall
    "unpaywall_email": "wibilaksonowijaya@mail.ugm.ac.id",
    "query": '"retrieval augmented generation" "document chunking" OR "text segmentation"',  # default search string
    "filters": {
        "from_pub_date": 2018,
        "until_pub_date": 2025,
    ...
    "rule_excludes": ["editorial", "blog", "preprint", "arXiv"],  # minimal
    "download_pdfs": True,
}
# ----------------------------
...
def main():
    ...
    RQS = [
        ...
        "How does document chunking method affect retrieval accuracy, quality of generation, and computational efficiency?",
    ]
